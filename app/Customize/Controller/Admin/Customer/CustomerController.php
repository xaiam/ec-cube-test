...
use Customize\Repository\CustomerChannelRepository;
...
{
    /**
     * @var CustomerChannelRepository
     */
    protected $customerChannelRepository;

    /**
     * CustomerChannelRepository constructor.
     *
     * @param CustomerChannelRepository $customerChannelRepository
     */
    public function __construct(CustomerChannelRepository $customerChannelRepository)
    {
    ...
    public function index(Request $request)
    {
        $customerChannels = $this->customerChannelRepository
            ->findBy(
                [],
                ['sortNo' => 'DESC']
            );
